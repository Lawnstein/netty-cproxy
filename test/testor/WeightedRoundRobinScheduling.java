...
public class WeightedRoundRobinScheduling {
	...
	public void init() {
		...
		Server s1 = new Server("192.168.0.100", 9);// 3
		Server s2 = new Server("192.168.0.101", 9);// 2
		Server s3 = new Server("192.168.0.102", 9);// 6
		Server s4 = new Server("192.168.0.103", 9);// 4
		Server s5 = new Server("192.168.0.104", 9);// 1
	...
	public static void main(String[] args) {
		...
		for (Entry<String, Integer> map : countResult.entrySet()) {
			logger.debug("服务器 " + map.getKey() + " 请求次数： " + map.getValue());
		}
	}
